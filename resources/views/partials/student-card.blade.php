    ...
    <div class="flex flex-col sm:flex-row">
        ...
        <div class="min-w-0 flex-1 p-5 sm:p-6">
            ...
            @if($student->description)
                <div class="mt-4">
                    <p class="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1">Abstract</p>
                    <p class="text-sm text-slate-600 leading-relaxed whitespace-pre-line">{{ $student->description }}</p>
                </div>
            @endif
